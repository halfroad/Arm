...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_CLK_ENABLE()               do { \
                                                        __IO uint32_t tmpreg; \
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_CLK_DISABLE()          CLEAR_BIT(RCC->AHB4ENR, RCC_AHB4ENR_OCTOSPI1EN)
#endif /* OCTOSPI1 */
...
#define __HAL_RCC_spi_CLK_DISABLE()           CLEAR_BIT(RCC->APB2ENR, RCC_APB2ENR_SPI1EN)
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_IS_CLK_ENABLED()          (READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_OCTOSPI1EN) != 0U)
#endif /* OCTOSPI1 */
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_IS_CLK_DISABLED()         (READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_OCTOSPI1EN) == 0U)
#endif /* OCTOSPI1 */
...
#define __HAL_RCC_spi_IS_CLK_ENABLED()        (READ_BIT(RCC->APB2ENR, RCC_APB2ENR_SPI1EN) != 0U)
...
#define __HAL_RCC_spi_IS_CLK_DISABLED()       (READ_BIT(RCC->APB2ENR, RCC_APB2ENR_SPI1EN) == 0U)
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_FORCE_RESET()     SET_BIT(RCC->AHB4RSTR, RCC_AHB4RSTR_OCTOSPI1RST)
#endif /* OCTOSPI1 */
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_RELEASE_RESET()   CLEAR_BIT(RCC->AHB4RSTR, RCC_AHB4RSTR_OCTOSPI1RST)
#endif /* OCTOSPI1 */
...
#define __HAL_RCC_spi_FORCE_RESET()          SET_BIT(RCC->APB2RSTR, RCC_APB2RSTR_SPI1RST)
...
#define __HAL_RCC_spi_RELEASE_RESET()        CLEAR_BIT(RCC->APB2RSTR, RCC_APB2RSTR_SPI1RST)
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_CLK_SLEEP_ENABLE()          SET_BIT(RCC->AHB4LPENR, RCC_AHB4LPENR_OCTOSPI1LPEN)
#endif /* OCTOSPI1 */
...
#if defined(OCTOSPI1)
#define __HAL_RCC_Ospi_CLK_SLEEP_DISABLE()         CLEAR_BIT(RCC->AHB4LPENR, RCC_AHB4LPENR_OCTOSPI1LPEN)
#endif /* OCTOSPI1 */
...
#define __HAL_RCC_spi_CLK_SLEEP_ENABLE()           SET_BIT(RCC->APB2LPENR, RCC_APB2LPENR_SPI1LPEN)
...
#define __HAL_RCC_spi_CLK_SLEEP_DISABLE()          CLEAR_BIT(RCC->APB2LPENR, RCC_APB2LPENR_SPI1LPEN)
