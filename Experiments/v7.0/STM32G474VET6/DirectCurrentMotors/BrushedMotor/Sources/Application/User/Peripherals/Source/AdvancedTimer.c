...
void InitAdvancedTimer(uint16_t prescaler, uint16_t autoReload,uint16_t defaultCompare)
{
    ...
    */
    ...
    TIM_Handle.Instance = ADVANCE_TIMER_INSTANCE;
    ...
    HAL_TIM_PWM_ConfigChannel(&TIM_Handle, &TIM_OC_InitType, ADVANCE_TIMER_CHANNEL);
    ...
    */
    ...
    HAL_TIMEx_ConfigBreakDeadTime(&TIM_Handle, &TIM_BreakDeadTimeConfigType);
}
