...
#define I2C_SCL_GPIO_PORT_BUS                   AHB4ENR
#define I2C_SCL_GPIO_PORT_BIT_NUMBER            1
#define I2C_SCL_PIN                             8

#define I2C_SDA_GPIO_PORT                       GPIOB
#define I2C_SDA_GPIO_PORT_BUS                   AHB4ENR
...
#define OLED_RES_CLR()                          I2C_SCL_GPIO_PORT -> BSRR |= 0x01 << (I2C_CS_PIN + 16)
#define OLED_RES_SET()                          I2C_SCL_GPIO_PORT -> BSRR |= 0x01 << I2C_CS_PIN
...
void OLED_Init(void)
{
    ...
    /*
     ...
     I2C_SCL_GPIO_PORT  ->  OTYPER &= ~(0x01 << I2C_SCL_PIN);
    ...
    /*
     ...
     Bit 1 GPIOBEN: I2C_SCL_GPIO_PORT peripheral clock enable
     Set and reset by software.
     0: I2C_SCL_GPIO_PORT peripheral clock disabled (default after reset)
     1: I2C_SCL_GPIO_PORT peripheral clock enabled
     
     */
    
    RCC -> I2C_SCL_GPIO_PORT_BUS |= 0x01 << I2C_SCL_GPIO_PORT_BIT_NUMBER; /* Enable the AHB4 clock for I2C_SCL_GPIO_PORT. */
    ...
    /*
     ...
     Bit 1 GPIOBEN: I2C_SDA_GPIO_PORT peripheral clock enable
     Set and reset by software.
     0: peripheral clock disabled (default after reset)
     1: peripheral clock enabled
     
     */
    
    RCC -> I2C_SDA_GPIO_PORT_BUS |= 0x01 << I2C_SDA_GPIO_PORT_BIT_NUMBER; /* Enable the AHB4 clock for I2C_SDA_GPIO_PORT. */
