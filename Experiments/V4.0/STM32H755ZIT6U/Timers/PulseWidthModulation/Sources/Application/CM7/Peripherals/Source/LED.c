...
void InitLEDs(void)
{
    ...
    */
    ...
    Controller      Pin     Pin Name    Signal name     STM32H7 pin     Function
    CN10            Pin 31  D33         TIMER_D_PWM1    PB0             TIM3_CH3
    ...
    */
    ...
    GPIOB -> MODER &= ~(0x03 << 14 * 2);
    GPIOB -> MODER |= 0x01 << 14 * 2;
