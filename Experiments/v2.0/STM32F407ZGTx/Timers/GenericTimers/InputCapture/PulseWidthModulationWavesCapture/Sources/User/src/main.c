...
int main(void)
{
	...
	*/  
	...
	init_pulse_width_modulation_waves_generator(840 - 1, 100 - 1);
	init_pulse_width_modulation_waves_capture(84 - 1, 0xffff);
	
	set_pulse_width_modulation_waves_generator_comparation(50);
