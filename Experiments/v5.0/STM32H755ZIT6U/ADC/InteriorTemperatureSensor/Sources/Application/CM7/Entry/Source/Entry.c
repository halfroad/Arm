...
#include "../../Peripherals/Include/InteriorTemperatureSensor.h"
...
int main(void)
{
    ...
    */
    ...
    while (1)
    {
        temperature = AcquireInteriorTemperature();
        
        sprintf(buffer, "Interior Temp: %.1fC", temperature);
