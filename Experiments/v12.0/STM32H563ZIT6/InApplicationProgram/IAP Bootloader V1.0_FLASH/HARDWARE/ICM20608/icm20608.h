...
//#define ICM_ACCEL_OFFS_REG		0X06	//accel_offs寄存器,可读取版本号,寄存器手册未提到
//#define ICM_PROD_ID_REG			0X0C	//prod id寄存器,在寄存器手册未提到
...
#define ICM_I2CMST_CTRL_REG		0X24	//IIC主机控制寄存器
#define ICM_I2CSLV0_ADDR_REG	0X25	//IIC从机0器件地址寄存器
#define ICM_I2CSLV0_REG			0X26	//IIC从机0数据地址寄存器
#define ICM_I2CSLV0_CTRL_REG	0X27	//IIC从机0控制寄存器
#define ICM_I2CSLV1_ADDR_REG	0X28	//IIC从机1器件地址寄存器
#define ICM_I2CSLV1_REG			0X29	//IIC从机1数据地址寄存器
#define ICM_I2CSLV1_CTRL_REG	0X2A	//IIC从机1控制寄存器
#define ICM_I2CSLV2_ADDR_REG	0X2B	//IIC从机2器件地址寄存器
#define ICM_I2CSLV2_REG			0X2C	//IIC从机2数据地址寄存器
#define ICM_I2CSLV2_CTRL_REG	0X2D	//IIC从机2控制寄存器
#define ICM_I2CSLV3_ADDR_REG	0X2E	//IIC从机3器件地址寄存器
#define ICM_I2CSLV3_REG			0X2F	//IIC从机3数据地址寄存器
#define ICM_I2CSLV3_CTRL_REG	0X30	//IIC从机3控制寄存器
#define ICM_I2CSLV4_ADDR_REG	0X31	//IIC从机4器件地址寄存器
#define ICM_I2CSLV4_REG			0X32	//IIC从机4数据地址寄存器
#define ICM_I2CSLV4_DO_REG		0X33	//IIC从机4写数据寄存器
#define ICM_I2CSLV4_CTRL_REG	0X34	//IIC从机4控制寄存器
#define ICM_I2CSLV4_DI_REG		0X35	//IIC从机4读数据寄存器
...
#define ICM_DEVICE_ID_REG		0X75	//器件ID寄存器

//如果AD0脚(4脚)接地,IIC地址为0X68(不包含最低位).
//如果接V3.3,则IIC地址为0X69(不包含最低位).
#define ICM_ADDR				0X68
 

u8 ICM20608_Init(void);								//初始化ICM6050
...
u8 ICM_Set_Gyro_Fsr(u8 fsr);	//设置陀螺仪传感器满量程范围
u8 ICM_Set_Accel_Fsr(u8 fsr);	//设置加速度传感器满量程范围
u8 ICM_Set_LPF(u16 lpf);		//设置低通滤波器
u8 ICM_Set_Rate(u16 rate);		//设置采样率
u8 ICM_Set_Fifo(u8 sens);		//设置FIFO


short ICM_Get_Temperature(void);							//获取温度传感器温度
u8 ICM_Get_Gyroscope(short *gx, short *gy, short *gz);		//获取陀螺仪传感器数据
u8 ICM_Get_Accelerometer(short *ax, short *ay, short *az);	//获取加速度传感器数据
