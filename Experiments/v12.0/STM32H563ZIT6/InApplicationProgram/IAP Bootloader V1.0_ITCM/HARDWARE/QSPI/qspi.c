...
u8 QSPI_Init(void)
{
    ...
    QSPI_Handler.Init.FlashSize=POSITION_VAL(0X0800000)-1;  //SPI FLASH大小，W25Q64大小为8M字节
...
void QSPI_Send_CMD(u8 cmd,u32 addr,u8 mode,u8 dmcycle)
{
	...
	Cmdhandler.InstructionMode=(mode>>0)&0x03;				//指令模式
	Cmdhandler.AddressMode=(mode>>2)&0x03;   					//地址模式
	Cmdhandler.AddressSize=(mode>>4)&0x03;   					//地址长度
	Cmdhandler.DataMode=(mode>>6)&0x03;             				//数据模式
