...
#define START_TASK4_STACK_DEPTH             128
#define START_TASK4_PRIORITY                  5
...
/* Definitions for StartTask4Handle */
TaskHandle_t StartTask4Handle;
StackType_t StartTask4Stack[START_TASK4_STACK_DEPTH];
StaticTask_t StartTask4TaskControlBlock;
...
static void StartTask4(void *argument);
...
void ScheduleTasks(void)
{
    ...
    StartTask4Handle = xTaskCreateStatic(StartTask4,
                                    "StartTask4Name", /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
                                    START_TASK4_STACK_DEPTH,
                                    NULL,
                                    START_TASK4_PRIORITY,
                                    StartTask4Stack,
                                    &StartTask4TaskControlBlock );
...
/* USER CODE BEGIN Header_StartRedYellowLEDTask */
/**
 * @brief Function implementing the FlashRedLEDTask thread.
 * @param argument: Not used
 * @retval None
 */
/* USER CODE END Header_StartRedYellowLEDTask  */
...
/**
 * @brief Function implementing the StartTask4 thread.
 * @param argument: Not used
 * @retval None
 */
