...
typedef struct
{
  ...
  uint32_t Spi1ClockSelection;     /*!< Specifies SPI1 clock source.
                                        This parameter can be a value of @ref RCCEx_spi_Clock_Source    */
...
/** @defgroup RCCEx_spi_Clock_Source SPI1 Clock Source
  * @{
  */
...
/** @brief  macro to configure the SPI1 clock source.
  ...
  *  (*) : For stm32h56xxx and stm32h57xxx family lines.
  */
#define __HAL_RCC_spi_CONFIG(__SPI1CLKSource__) \
...
/** @brief  macro to get the SPI1 clock source.
  ...
  *  (*) : For stm32h56xxx and stm32h57xxx family lines.
  */
#define __HAL_RCC_GET_spi_SOURCE() ((uint32_t)(READ_BIT(RCC->CCIPR3, RCC_CCIPR3_SPI1SEL)))
