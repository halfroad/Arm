...
#define ENABLE_GREEN_LED_GPIO_PORT_CLOCK()          do                                  \
                                                    {                                   \
...
#define ENABLE_YELLOW_LED_GPIO_PORT_CLOCK()         do                                  \
                                                    {                                   \
...
#define ENABLE_RED_GPIO_PORT_CLOCK()                do                                  \
                                                    {                                   \
...
int main (void)
{
    ...
    ENABLE_GREEN_LED_GPIO_PORT_CLOCK();
