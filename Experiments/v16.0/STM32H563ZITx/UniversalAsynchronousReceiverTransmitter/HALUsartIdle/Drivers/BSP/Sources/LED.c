...
#define GREEN_LED_GPIO_RCC_CLOCK_ENABLE()                               do                                          \
                                                                        {                                           \
                                                                            __HAL_RCC_GPIOB_CLK_ENABLE();           \
                                                                        }                                           \
                                                                        while (0)                                   \

#define GREEN_LED_GPIO_RCC_CLOCK_DISABLE()                              do                                         \
                                                                        {                                           \
...
#define YELLOW_LED_GPIO_RCC_CLOCK_ENABLE()                              do                                          \
                                                                        {                                           \
                                                                            __HAL_RCC_GPIOF_CLK_ENABLE();           \
                                                                        }                                           \
                                                                        while (0)                                   \

#define YELLOW_LED_GPIO_RCC_CLOCK_DISABLE()                             do                                          \
                                                                        {                                           \
...
#define RED_LED_GPIO_RCC_CLOCK_ENABLE()                                 do                                          \
                                                                        {                                           \
                                                                            __HAL_RCC_GPIOG_CLK_ENABLE();           \
                                                                        }                                           \
                                                                        while (0)                                   \

#define RED_LED_GPIO_RCC_CLOCK_DISABLE()                                do                                          \
                                                                        {                                           \
