...
#define GREEN_LED_GPIO_CLOCK_ENABLE()   do                                  \
                                        {                                   \
...
int main(void)
{
    ...
    */
    ...
    GREEN_LED_GPIO_PORT -> MODER &= ~(0x03UL << 0);
    GREEN_LED_GPIO_PORT -> MODER |= (0x01UL << 0);
    
    GREEN_LED_GPIO_PORT -> PUPDR &= ~(0x03UL << 0);
    ...
    while (1)
    {
        ...
        */
        ...
        GREEN_LED_GPIO_PORT -> BSRR |= (0x01 << 16);
        HAL_Delay(500);
    }
}
