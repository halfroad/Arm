...
#include "./Peripherals/DigitalAnalogyConverter/Include/TriangularWaves.h"
    ...
    while (1)
    {
        if (0x2000 == (GPIOC -> IDR & 0x2000))
        {
            ...
            if (0x2000 == (GPIOC -> IDR & 0x2000))
            {
                ...
                if (state & 0x01 << 7)
                {
                    OLED_ShowString(0, 0, (uint8_t *)"Sampling 2000 times.", 8, 1);
                    
                    GenerateTriangularWaves(4095, 5, 2000, 100);
                }
                else
                {
                    OLED_ShowString(0, 0, (uint8_t *)"Sampling 20 times.", 8, 1);
                    
                    GenerateTriangularWaves(4095, 500, 20, 100);
                }
