...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线
#define NRF24L01_CE(n)   (n?HAL_GPIO_WritePin(GPIOD,GPIO_PIN_8,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOD,GPIO_PIN_8,GPIO_PIN_RESET))//24L01片选信号
#define NRF24L01_CSN(n)  (n?HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5,GPIO_PIN_RESET))//SPI片选信号	   
#define NRF24L01_IRQ     HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_9)//IRQ主机数据输入
//24L01发送接收数据宽度定义
