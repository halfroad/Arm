...
#include "./Peripherals/CM7/Include/OLEDFont.h"       
#include "./Peripherals/CM7/Include/Delay.h"

//----------------- OLED Port definitions ---------------- 

#define I2C_GPIO_PORT                           GPIOB
#define I2C_GPIO_PORT_BIT_NUMBER                1
...
#define OLED_SCL_CLR()                          I2C_GPIO_PORT -> BSRR |= 0x01 << (I2C_SCL_PIN + 16)
#define OLED_SCL_SET()                          I2C_GPIO_PORT -> BSRR |= 0x01 << I2C_SCL_PIN

#define OLED_SDA_CLR()                          I2C_GPIO_PORT -> BSRR |= 0x01 << (I2C_SDA_PIN + 16)
#define OLED_SDA_SET()                          I2C_GPIO_PORT -> BSRR |= 0x01 << I2C_SDA_PIN
...
void OLED_Init(void)
{
    ...
    RCC -> AHB4ENR |= 0x01 << I2C_GPIO_PORT_BIT_NUMBER; /* Enable the AHB4 clock for I2C_GPIO_PORT. */
    ...
    I2C_GPIO_PORT -> MODER &= ~(0x03 << I2C_SCL_PIN * 2); /* Generic output. */
    I2C_GPIO_PORT -> MODER |= 0x01 << I2C_SCL_PIN * 2;
    ...
    I2C_GPIO_PORT -> OTYPER |= 0x01 << I2C_SCL_PIN; /* Open Drain. */
     ...
     */
    I2C_GPIO_PORT -> OSPEEDR &= ~(0x03 << I2C_SCL_PIN * 2);
    I2C_GPIO_PORT -> OSPEEDR |= 0x02 << I2C_SCL_PIN * 2;
    ...
    I2C_GPIO_PORT -> PUPDR &= ~(0x03 << I2C_SCL_PIN * 2);
    I2C_GPIO_PORT -> PUPDR |= 0x01 << I2C_SCL_PIN * 2;

    /* Configure I2C1_SDA on PB9. */

    I2C_GPIO_PORT -> MODER &= ~(0x03 << I2C_SDA_PIN * 2);
    I2C_GPIO_PORT -> MODER |= 0x01 << I2C_SDA_PIN * 2;

    I2C_GPIO_PORT -> OTYPER |= 0x01 << I2C_SDA_PIN;

    I2C_GPIO_PORT -> OSPEEDR &= ~(0x03 << I2C_SDA_PIN * 2);
    I2C_GPIO_PORT -> OSPEEDR |= 0x02 << I2C_SDA_PIN * 2;

    I2C_GPIO_PORT -> PUPDR &= ~(0x03 << I2C_SDA_PIN * 2);
    I2C_GPIO_PORT -> PUPDR |= 0x01 << I2C_SDA_PIN * 2;
